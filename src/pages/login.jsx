    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .divider-text { font-size: 12px; color: rgba(255,255,255,0.2); white-space: nowrap; }
        ...
        .footer {
          ...
          animation: cardIn 0.7s 0.48s cubic-bezier(0.16,1,0.3,1) both;
        }
        .footer a {
          color: #a78bfa;
          text-decoration: none;
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="field">
              ...
              <div className={`field-wrap${focused === "email" ? " is-focused" : ""}`}>
                <svg className="field-icon" width="16" height="16" fill="none" viewBox="0 0 24 24">
